...
| PHP | [phpseclib #2165](https://github.com/phpseclib/phpseclib/pull/2165) · [#2167](https://github.com/phpseclib/phpseclib/pull/2167) **(merged)** · [#2168](https://github.com/phpseclib/phpseclib/pull/2168) **(merged)** · [composer/semver #184](https://github.com/composer/semver/pull/184) · [league/csv #586](https://github.com/thephpleague/csv/issues/586) **(reported)** |
